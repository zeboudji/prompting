...
st.markdown("""
    <div style="display: flex; align-items: center;">
        <img src="https://www.greatplacetowork.fr/assets/Affiliate-France/_resampled/ScaleHeightWyI2MDAiXQ/FR-00904-Inside-Group.png" alt="Logo" style="height: 60px; margin-right: 10px;">
